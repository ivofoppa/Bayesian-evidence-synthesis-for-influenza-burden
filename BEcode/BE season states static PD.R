...
#########################################################################################
#########################################################################################
bfolder <- 'C:/Users/VOR1/GitHub/Bayesian-evidence-synthesis-for-influenza-burden/'
...
for (state in statevec) {
  ...
  for (seas in 1:nseas) {
    ...
    statestarr <- rbind(statestarr,estrow,deparse.level = 0)
  }
  estList[[agcat]] <- statestarr
}
#########################################################################################
#########################################################################################
seastotarr <- NULL
