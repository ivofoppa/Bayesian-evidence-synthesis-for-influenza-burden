...
model.file <- 'BE season OSH beta Dirichlet.txt'
...
outfile <- "codafileFSN_OSH_beta_Dirichlet_2012-17.RData"
...
outtablename1 <- "BES hosp beta dirichlet 2012-17.txt"
outtablename2 <- "BES mort beta dirichlet 2012-17.txt"
#########################################################################################
#########################################################################################
fromyr <- 2012
toyr <- 2017
